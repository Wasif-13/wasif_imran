...
variables = ['mpg', 'cyl', 'disp', 'drat']
for var in variables:
    plt.figure()
    sns.regplot(x=var, y= 'hp', data=df).set(title=f'regression plot between {var} and hp')
    plt.show()
...
g = sns.heatmap(correlations, annot=True, cmap='coolwarm').set(title='Heatmap of MtCars ')
plt.show()
read = input("wait...")
