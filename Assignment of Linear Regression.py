...
def calc(slope, intercept, AssessedValue):
    return slope*AssessedValue+intercept

score = calc(regressor.coef_, regressor.intercept_, [110500.00, 219900.00, 43400.00])
print(score)

score = regressor.predict([[110500.00]])
print(score)

score = regressor.predict([[219900.00]])
print(score)

score = regressor.predict([[43400.00]])
print(score)
